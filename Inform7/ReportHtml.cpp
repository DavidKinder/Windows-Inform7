...
// Execute JavaScript to adjust HTML generated by the compiler to
// look okay in Windows' dark mode.
void ReportHtml::ModifyHTMLForDarkMode(void)
{
  ...
  if (m_url != blankPath)
  {
    ...
    RunJavaScript("document.body.style.backgroundColor = 'lightgrey';");
  }
}
