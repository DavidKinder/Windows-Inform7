...
#define SCNX_SETSCROLLINFO 2050
struct SCNXSetScrollInfo {
	struct Sci_NotifyHeader nmhdr;
  int nBar;
  const void* lpsi;
  int bRedraw;
...
#define SCNX_GETSCROLLINFO 2051
struct SCNXGetScrollInfo {
	struct Sci_NotifyHeader nmhdr;
  int nBar;
  void* lpsi;
};
...
#define SCNX_CONVERTPASTE 2052
struct SCNXConvertPaste {
	struct Sci_NotifyHeader nmhdr;
  void* source;
  wchar_t* utext;
  int ulen;
...
/*XXXXDK Change copied clipboard text */
#define SCNX_CONVERTCOPYTOCLIP 2053
struct SCNXConvertCopyToClip {
	struct Sci_NotifyHeader nmhdr;
  char* text;
};
/*XXXXDK Change copied clipboard text */
...
#define SCIX_VISIBLEREGION 4900
#define SCIX_ISLINEINVISIBLEREGION 4901
#define SCIX_VISIBLEREGIONSTART 4902
