...
"%ProgramFiles(x86)%\Zip\zip" \Temp\Windows_UI_source.zip Adv\Inform7\BuildDate\*.vcproj Adv\Inform7\BuildDate\*.cpp
"%ProgramFiles(x86)%\Zip\zip" \Temp\Windows_UI_source.zip Adv\Inform7\Inform7\res\* Adv\Inform7\Inform7\*.cpp Adv\Inform7\Inform7\*.c Adv\Inform7\Inform7\*.h Adv\Inform7\Inform7\*.rc Adv\Inform7\Inform7\*.vcproj Adv\Inform7\Inform7\*.sln
...
"%ProgramFiles(x86)%\Zip\zip" \Temp\Windows_UI_source.zip Adv\Inform7\Installer\PlugIn\*.cpp Adv\Inform7\Installer\PlugIn\*.sln Adv\Inform7\Installer\PlugIn\*.vcproj
...
"%ProgramFiles(x86)%\Zip\zip" \Temp\Windows_UI_source.zip Libraries\mfc\* Libraries\libpng\* Libraries\zlib\* Libraries\jpeg\* Libraries\hunspell\*
"%ProgramFiles(x86)%\Zip\zip" \Temp\Windows_UI_source.zip Libraries\scalegfx\*.h Libraries\scalegfx\*.cpp Libraries\scalegfx\*.def Libraries\scalegfx\Makefile
"%ProgramFiles(x86)%\Zip\zip" \Temp\Windows_UI_source.zip Libraries\libmodplug\*
"%ProgramFiles(x86)%\Zip\zip" \Temp\Windows_UI_source.zip Libraries\libvorbis\*
"%ProgramFiles(x86)%\Zip\zip" -r \Temp\Windows_UI_source.zip Libraries\libvorbis\include\* Libraries\libvorbis\lib\*
"%ProgramFiles(x86)%\Zip\zip" \Temp\Windows_UI_source.zip Libraries\libogg\*
"%ProgramFiles(x86)%\Zip\zip" -r \Temp\Windows_UI_source.zip Libraries\libogg\include\* Libraries\libogg\src\*
popd
